...
//Donovan Tengblad : Changed namespace
namespace Probesys\GeneratorBundle\Generator;

//Donovan Tengblad : Added use
 ...
 *
 * @author Fabien Potencier <fabien@symfony.com>, edited by Donovan Tengblad
 */
class DoctrineCrudGenerator extends Generator
{
    ...
    public function generate(BundleInterface $bundle, $entity, ClassMetadataInfo $metadata, $format, $routePrefix, $needWriteActions)
    {
        ...
        //Donovan Tengblad : Added bulk
        $this->actions = $needWriteActions ? array('index', 'show', 'new', 'edit', 'delete', 'bulk') : array('index', 'show');
        ...
        //Donovan Tengblad : Added Delete
        if (in_array('delete', $this->actions)) {
            $this->generateDeleteView($dir);
        }

        //Donovan Tengblad : Added Bulk
        if (in_array('bulk', $this->actions)) {
     ...
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    private function generateDeleteView($dir)
    {
        $this->renderFile($this->skeletonDir, 'views/delete.html.twig', $dir.'/delete.html.twig', array(
            'dir'               => $this->skeletonDir,
            'entity'            => $this->entity,
            'fields'            => $this->metadata->fieldMappings,
            'actions'           => $this->actions,
     ...
     * @param string $dir The path to the folder that hosts templates in the bundle
     */
    private function generateBulkView($dir)
    {
        $this->renderFile($this->skeletonDir, 'views/bulk.html.twig', $dir.'/bulk.html.twig', array(
            'dir'               => $this->skeletonDir,
            'entity'            => $this->entity,
            'fields'            => $this->metadata->fieldMappings,
            'actions'           => $this->actions,
